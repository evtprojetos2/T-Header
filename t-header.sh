...
do
	tput civis
	echo -ne "\033[34m\r[*] Baixando..por favor aguarde.........\e[33m[\033[32m$i\033[33m]\033[0m   ";
	sleep $delay
...
echo "";
echo -e "\e[1;34m[*] \e[32minstalando pacotes....\e[0m";
echo "";
...
rubygem_d &> /dev/null
termux-wake-lock;
if [ -e $PREFIX/share/figlet/Evtpro773.flf ]; then
	echo -e "\e[1;34m[*] \033[32mEvtpro773.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/evtprojetos2/evtpro773/main/Evtpro773.flf &> /dev/null;
sleep 3
cp Evtpro773.flf $PREFIX/share/figlet/Evtpro773.flf;
...
do
	echo ""
tput setaf 3
read -p "Por favor insira o nome : " PROC
tput sgr 0
if [[ ${#PROC} -gt 8 ]]; then
	echo -e "\e[1;34m[*] \033[32mCaracteres muito longos Você inseriu...\033[0m"
	echo ""
	echo -e "\033[32mPor favor, insira menos de \033[33m9 \033[32mcharacters Name\033[0m" | pv -qL 10;
	echo ""
	sleep 4
	clear
echo -e "\033[01;32m
...
\033[0m";
	echo ""
	echo -e "\e[1;34m \033[32mPor favor insira menos de 9 caracteres...\033[0m"
	echo ""
else
	ok=1
fi
...
tput setaf 3
read -p  "Você quer configurar isso ? (y/n) " PROC32
tput sgr 0
if [[ ${PROC32} == [Y/y] ]]; then
...
source ~/.zshrc;
	...
	echo -e "\033[32mEspero que você goste do meu trabalho..\033[0m"
fi
exit
}
...
\033[0m";
tput setaf 3;
read -p  "Você quer configurar isso ? (y/n) " PROC33
...
if [ -d $HOME/.plugins/zsh-syntax-highlighting ];then
	...
	echo -e "\e[1;34m[*] \033[32mEspero que você goste do meu trabalho..\033[0m"
	exit
fi
exit 0
